...
texts_dir = os.path.join(downloads_main_dir, 'text_files')
image_dir = os.path.join(downloads_main_dir, 'image_files')
audio_dir = os.path.join(downloads_main_dir, 'audio_files')
video_dir = os.path.join(downloads_main_dir, 'video_files')
compressed_dir = os.path.join(downloads_main_dir, 'compressed_files')
data_dir = os.path.join(downloads_main_dir, 'data_files')
...
class MoveHandler(FileSystemEventHandler):
    def on_modified(self, event):
      with os.scandir(downloads_main_dir) as all_files:
          for file in all_files:
              name = file.name
              destination = downloads_main_dir
...
if __name__ == "__main__":
    logging.basicConfig(level=logging.INFO,
                        ...
                        datefmt='%Y-%m-%d %H:%M:%S')
    path = downloads_main_dir  #directory we track
